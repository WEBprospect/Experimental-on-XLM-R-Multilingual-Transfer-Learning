...
| Fine-tune 전략 | 주요 특징 | 평균 F1 | 비고 |
|:--|:--|:--:|:--|
| Zero-shot (de) | 한 언어로 학습, 전이만 수행 | ~0.72 | 데이터 비용 최소 |
| Few-shot (fr ≤ 1000) | 소량 타겟 데이터 추가 학습 | ~0.80 | 효율적 전이 |
| Multilingual (de+fr) | 언어 간 시너지 효과 | ~0.78 | 균형적 학습 |
| Full Fine-tuning (all) | 전체 언어 동시 학습 | **~0.85** | 최종 최적화 모델 |
...
앞으로는 이런 전이학습 개념을 **저자원 언어나 멀티모달 환경**으로 확장해보고 싶습니다.
